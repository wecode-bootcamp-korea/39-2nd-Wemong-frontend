...
const Calendar = props => {
  ...
  return (
    <>
      <style>{`
      .rdp {display: flex; align-items: center; justify-content: center; width: 350px; border: 1px solid #eceaeb; margin: auto; padding: 20px 0px; border-radius: 20px; margin-top: 30px;}
